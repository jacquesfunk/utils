...
extracted_values = df['error_message'].apply(lambda x: x.split(': ')[1] if ': ' in x else None).dropna()
...
unique_values_df.to_csv(r'C:\Users\mahmad\OneDrive - Ryan RTS\Downloads\unique_values.csv', index=False)
