...
columns_to_drop = [col for col in df.columns if any(substring in col for substring in ["Rank", "1", "3"])] + ["Season"]
filtered_df = df.drop(columns_to_drop)

# Save the updated DataFrame to a new CSV file
output_file_path = r"C:\Users\mahmad\OneDrive - Ryan RTS\Downloads\pointdist25-filtered.csv"
