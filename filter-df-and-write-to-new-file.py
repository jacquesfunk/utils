...
notes_filtered_sorted = notes_filtered.sort_values(by=['title', 'user-or-security-group'])
recommendation_filtered_sorted = recommendation_filtered.sort_values(by=['title', 'user-or-security-group'])
