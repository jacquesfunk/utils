...
df['access-type'] = df.apply(lambda row: 'guest' if row['guest'] == 'Yes' else
                                        'modify' if row['modify'] == 'Yes' else
                                        'view' if row['view'] == 'Yes' else
                                        'admin' if row['admin'] == 'Yes' else '', axis=1)
