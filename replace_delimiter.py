...
try:
    df2 = pd.read_csv('TransactionSummaryLLCGrp_Daily_184835_05-09-2024.csv', on_bad_lines='skip')
    ...
    df2.columns = [col.replace('|', ',') if isinstance(col, str) else col for col in df2.columns]
