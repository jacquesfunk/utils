...
df_alldata = pd.read_csv(r"C:\Users\mahmad\OneDrive - Ryan RTS\Downloads\cadence_mra_compliance_sf_2025-03-01000.csv")
...
filtered_data = df_alldata[df_alldata['id'].isin(search_items)]
