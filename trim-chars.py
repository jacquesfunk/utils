...
df1 = pd.read_csv(r'C:\Users\mahmad\OneDrive - Ryan RTS\Downloads\order_post_hist-20241210-LME.csv', on_bad_lines='warn')
df2 = pd.read_csv(r'C:\Users\mahmad\OneDrive - Ryan RTS\Downloads\order_post_hist-20241210-Aurora_Prod.csv', on_bad_lines='warn')
